# 2nd Project of Python Automation

# Automated platform survillance system Project
# python ProcessSurvillance.py 2 MarvellousLog
# python ProcessSurvillance.py Time interval Folder_Name
# len(sys.argv) -->3

#python ProcessSurvillance.py --h
# python ProcessSurvillance.py --u
# it is based on the create the folder and create the log file and send the log file into mail
# it uses the psutil module to fetch the information about the system and process 
